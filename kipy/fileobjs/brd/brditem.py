'''
Main class for parsing and rendering .brd files.
...
class BrdItem(object):
    ...
    def subparse(cls, schpage, tokens, lineiterator):
        #print 'GONNA BLOW cls=', cls.__name__, ' schpage=', schpage.__class__.__name__
        #print tokens, cls.tokenlength[0], cls.tokenlength[-1], schpage.parsestate
